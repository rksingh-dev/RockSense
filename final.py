...
class ImageClusterer:
    ...
    def save_outputs(self) -> None:
        ...
        try:
            ...
            # Allow downloading the saved files
            files.download('clustered_image.png')
            files.download('cluster_statistics.txt')
...
def process_uploaded_file(n_clusters: int = 15):
    """Process uploaded file using Google Colab's file uploader."""
    try:
        print("Please select an image file when the file dialog appears...") 
        ...
        if uploaded:
            ...
            for filename, content in uploaded.items():
                ...
                clusterer.process_image(content)

    except Exception as e:
        logger.error(f"Error in file upload: {str(e)}")
        print(f"Error in file upload: {str(e)}")

# Run this to start the file upload process
print("Image Clustering Tool")
print("This will cluster your image into regions based on color similarity.")
